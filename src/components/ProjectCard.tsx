...
export const ProjectCard = ({ project, onSelect }: ProjectCardProps) => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className="group relative overflow-hidden rounded-xl bg-white shadow-md transition-all duration-300 hover:shadow-lg border border-gray-200 w-full max-w-2xl mx-auto"
    >
